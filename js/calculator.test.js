...
function testClearAfterCalculation () {
  ...
  console.assert(
    ...
    'Clear after calculation: Display is 0'
  )
  console.assert(
    clearButton.textContent === 'AC',
    'Clear after calculation: Clear Button is AC'
  )
  console.assert(
    firstValue,
    'Clear After Calculation: firstValue should remain'
  )
...
function testFullClear () {
  ...
  console.assert(
    !calculator.state.modifierValue,
    'Full Clear: No operator value'
  )
}
